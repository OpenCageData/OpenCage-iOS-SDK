...
public typealias ReverseGeocoderCompletionBlock  = (_ addressArray :OCGeoResponse, _ success: Bool, _ error: NSError?) -> ()
public typealias ForwardGeocoderCompletionBlock  = (_ locationArray :OCGeoResponse, _ success: Bool, _ error: NSError?) -> ()
